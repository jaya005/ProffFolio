...
const Blog = () => {
  ...
  const fetchBlogs = async () => {
    try {
      const response = await axios.get("https://profffolio-4.onrender.com//blogs");
...
>
  <img
    src={`https://profffolio-4.onrender.com//uploads/${blog.image}`}
    alt={blog.title}
        ...
        >
          {selectedBlog && (
            <>
              ...
              <Modal.Body>
                <img
                  src={`https://profffolio-4.onrender.com//uploads/${selectedBlog.image}`}
