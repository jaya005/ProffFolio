...
const Achievements = () => {
  ...
  const fetchAchievements = async () => {
    try {
      const response = await axios.get("https://profffolio-4.onrender.com//achievements");
            ...
            >
              <div className="achievement-card">
                <div className="card-image-container">
                  <img
                    src={`https://profffolio-4.onrender.com//uploads/${achievement.image}`}
          ...
          <>
            ...
            <Modal.Body className="modal-body">
              <div className="modal-image-container">
                <img
                  src={`https://profffolio-4.onrender.com//uploads/${selectedAchievement.image}`}
