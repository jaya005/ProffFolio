...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get("https://profffolio-4.onrender.com//projects");
            ...
            filteredProjects.map((project, index) => (
              ...
              >
                <div className="card-image-container">
                  <img
                    src={`https://profffolio-4.onrender.com//uploads/${project.image}`}
                    alt={project.name}
            ...
            <>
              ...
              <Modal.Body>
                <div className="modal-image-container">
                  <img
                    src={`https://profffolio-4.onrender.com//uploads/${selectedProject.image}`}
