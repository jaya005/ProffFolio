...
const UpdateItem = () => {
  ...
  const handleFetchItem = async () => {
    ...
    try {
      const response = await axios.get(
        `https://profffolio-4.onrender.com//${selectedSection}/${encodeURIComponent(
          itemName
        )}`
      );
  ...
  const handleUpdateItem = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://profffolio-4.onrender.com//${selectedSection}/update/${encodeURIComponent(itemName)}`,
        formData,
        ...
        <div>
          ...
          {updateData.image && (
            <div className="mb-3">
              ...
              <div>
                <img
                  src={`https://profffolio-4.onrender.com//uploads/${updateData.image}`}
                  alt="Current"
